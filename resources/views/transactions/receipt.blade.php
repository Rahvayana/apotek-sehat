...
<table class="receipt-table">
    <tbody>
        <tr><td colspan="3"><h2 class="text-center">Apotek Sulfa Sulfida</h2></td></tr>
        <tr>
            <td colspan="3">
                <p class="text-center">Jl. Kusuma Bangsa Lamongan</p>
                <p class="text-center">Telp: 085853030031</p>
            </td>
        </tr>
        <tr>
            <td style="width:85px">{{ trans('transaction.invoice_no') }}</td>
        ...
        <tr><th colspan="2" class="text-left">{{ trans('transaction.items') }}</th></tr>
        <tr>
